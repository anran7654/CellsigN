...
folder_path = 'D:/Personal issues/CSNet/tool/interaction data/mouse/ligand-receptor/'
...
with open(f"D:/Personal issues/CSNet/tool/interaction data/mouse/ligand-receptor/combined_lr.txt", "w") as f:
    f.write(f"Ligand\tReceptor\tScore\n")
